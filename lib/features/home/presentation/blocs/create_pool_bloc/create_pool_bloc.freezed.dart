...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( CreatePoolBanksFetchRequested value)?  banksFetchRequested,TResult Function( CreatePoolAccountLookupRequested value)?  accountLookupRequested,TResult Function( CreatePoolAccountLookupCleared value)?  accountLookupCleared,required TResult orElse(),}){
final _that = this;
switch (_that) {
case CreatePoolBanksFetchRequested() when banksFetchRequested != null:
return banksFetchRequested(_that);case CreatePoolAccountLookupRequested() when accountLookupRequested != null:
return accountLookupRequested(_that);case CreatePoolAccountLookupCleared() when accountLookupCleared != null:
return accountLookupCleared(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( CreatePoolBanksFetchRequested value)  banksFetchRequested,required TResult Function( CreatePoolAccountLookupRequested value)  accountLookupRequested,required TResult Function( CreatePoolAccountLookupCleared value)  accountLookupCleared,}){
final _that = this;
switch (_that) {
case CreatePoolBanksFetchRequested():
return banksFetchRequested(_that);case CreatePoolAccountLookupRequested():
return accountLookupRequested(_that);case CreatePoolAccountLookupCleared():
return accountLookupCleared(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( CreatePoolBanksFetchRequested value)?  banksFetchRequested,TResult? Function( CreatePoolAccountLookupRequested value)?  accountLookupRequested,TResult? Function( CreatePoolAccountLookupCleared value)?  accountLookupCleared,}){
final _that = this;
switch (_that) {
case CreatePoolBanksFetchRequested() when banksFetchRequested != null:
return banksFetchRequested(_that);case CreatePoolAccountLookupRequested() when accountLookupRequested != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  banksFetchRequested,TResult Function( String accountNumber,  String bankCode)?  accountLookupRequested,TResult Function()?  accountLookupCleared,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CreatePoolBanksFetchRequested() when banksFetchRequested != null:
return banksFetchRequested();case CreatePoolAccountLookupRequested() when accountLookupRequested != null:
...
return accountLookupCleared();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  banksFetchRequested,required TResult Function( String accountNumber,  String bankCode)  accountLookupRequested,required TResult Function()  accountLookupCleared,}) {final _that = this;
switch (_that) {
case CreatePoolBanksFetchRequested():
return banksFetchRequested();case CreatePoolAccountLookupRequested():
return accountLookupRequested(_that.accountNumber,_that.bankCode);case CreatePoolAccountLookupCleared():
return accountLookupCleared();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  banksFetchRequested,TResult? Function( String accountNumber,  String bankCode)?  accountLookupRequested,TResult? Function()?  accountLookupCleared,}) {final _that = this;
switch (_that) {
case CreatePoolBanksFetchRequested() when banksFetchRequested != null:
return banksFetchRequested();case CreatePoolAccountLookupRequested() when accountLookupRequested != null:
return accountLookupRequested(_that.accountNumber,_that.bankCode);case CreatePoolAccountLookupCleared() when accountLookupCleared != null:
...
mixin _$CreatePoolState {
 ...
 List<Bank> get banks; String? get banksError; CreatePoolRequestStatus get accountLookupStatus;/// The account resolved by the last name enquiry, cleared when a new
/// lookup starts so a stale name is never shown against fresh input.
 BankAccount? get resolvedAccount; String? get accountLookupError;
...
@useResult
$Res call({
 CreatePoolRequestStatus banksStatus, List<Bank> banks, String? banksError, CreatePoolRequestStatus accountLookupStatus, BankAccount? resolvedAccount, String? accountLookupError
});
...
/// Create a copy of CreatePoolState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? banksStatus = null,Object? banks = null,Object? banksError = freezed,Object? accountLookupStatus = null,Object? resolvedAccount = freezed,Object? accountLookupError = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CreatePoolRequestStatus banksStatus,  List<Bank> banks,  String? banksError,  CreatePoolRequestStatus accountLookupStatus,  BankAccount? resolvedAccount,  String? accountLookupError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreatePoolState() when $default != null:
return $default(_that.banksStatus,_that.banks,_that.banksError,_that.accountLookupStatus,_that.resolvedAccount,_that.accountLookupError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CreatePoolRequestStatus banksStatus,  List<Bank> banks,  String? banksError,  CreatePoolRequestStatus accountLookupStatus,  BankAccount? resolvedAccount,  String? accountLookupError)  $default,) {final _that = this;
switch (_that) {
case _CreatePoolState():
return $default(_that.banksStatus,_that.banks,_that.banksError,_that.accountLookupStatus,_that.resolvedAccount,_that.accountLookupError);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CreatePoolRequestStatus banksStatus,  List<Bank> banks,  String? banksError,  CreatePoolRequestStatus accountLookupStatus,  BankAccount? resolvedAccount,  String? accountLookupError)?  $default,) {final _that = this;
switch (_that) {
case _CreatePoolState() when $default != null:
return $default(_that.banksStatus,_that.banks,_that.banksError,_that.accountLookupStatus,_that.resolvedAccount,_that.accountLookupError);case _:
  return null;
...
class _CreatePoolState extends CreatePoolState {
  const _CreatePoolState({this.banksStatus = CreatePoolRequestStatus.initial,  List<Bank> banks = const <Bank>[], this.banksError, this.accountLookupStatus = CreatePoolRequestStatus.initial, this.resolvedAccount, this.accountLookupError}): _banks = banks,super._();
...
@override
int get hashCode => Object.hash(runtimeType,banksStatus,const DeepCollectionEquality().hash(_banks),banksError,accountLookupStatus,resolvedAccount,accountLookupError);
...
/// Create a copy of CreatePoolState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? banksStatus = null,Object? banks = null,Object? banksError = freezed,Object? accountLookupStatus = null,Object? resolvedAccount = freezed,Object? accountLookupError = freezed,}) {
