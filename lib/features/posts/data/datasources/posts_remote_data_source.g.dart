...
class _PostsRemoteDataSource implements PostsRemoteDataSource {
  _PostsRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<PostDto> createPost(PostDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<PostDto> updatePost(int id, PostDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
